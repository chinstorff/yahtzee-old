...
13.times do |i|
  #roll = display game.get_data, [0,0,0,0,0], "", "", "Select your roll"
  roll = "33333";
  game.set_dice roll.split("").map {|x| x.to_i}
  ...
  while success != 1
    ...
    m1 = "Selection invalid" if success == -1
    m1 = "Use Joker rules,"  if success == 0
    puts success
  end
end
